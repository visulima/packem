---
title: Hooks
description: Use build lifecycle hooks to extend Packen's functionality
---
...
Hooks allow you to tap into Packen's build lifecycle and execute custom logic at specific points during the build process. This enables advanced customization and integration with external tools.
