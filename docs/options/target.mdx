...
The target option determines which JavaScript features and runtime environments your code should support. Packen uses this to configure transformers and polyfills appropriately.
