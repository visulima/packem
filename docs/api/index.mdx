---
title: API Reference
description: Complete API documentation for all Packem packages and their features
---

# API Reference

Complete API documentation for all Packem packages. Each package provides specific functionality for the Packem bundling ecosystem.

## Core Packages

<div className="api-grid">
  **[@visulima/packem](/docs/api/packem)** - Main bundler package with CLI and core functionality

  **[@visulima/packem-rollup](/docs/api/packem-rollup)** - Rollup plugins and transformer integrations

  **[@visulima/rollup-plugin-css](/docs/api/rollup-plugin-css)** - CSS processing and optimization plugin

  **[@visulima/css-style-inject](/docs/api/css-style-inject)** - Runtime CSS injection utility

  **[@visulima/packem-share](/docs/api/packem-share)** - Shared types, utilities, and constants
</div>
...
### Plugin APIs
- [`nativeModulesPlugin`](/docs/api/native-modules-plugin) - Native Node.js addon support
- [`requireCJSTransformerPlugin`](/docs/api/require-cjs-transformer) - CJS import optimization

### CSS APIs
- [`CssOptions`](/docs/api/rollup-plugin-css#cssoptions) - CSS configuration
- [`SassOptions`](/docs/api/rollup-plugin-css#sassoptions) - Sass configuration
- [`PostCssOptions`](/docs/api/rollup-plugin-css#postcssoptions) - PostCSS configuration
...
// CSS configuration (from rollup-plugin-css)
...
```typescript
import type { CssLoader } from '@visulima/rollup-plugin-css'
...
Packem respects several environment variables:
...
| `@visulima/rollup-plugin-css` | ^0.0.0 | >=20.0.0 | >=4.5.0 |
...
<div className="package-list">
  ...
  <a href="/docs/api/packem-rollup" className="package-link">
    ...
    <p>Rollup plugins for all supported transformers, build optimizations, and native module support</p>
    <div className="package-stats">
      Plugins
      Transformers
      Rollup
  ...
  <a href="/docs/api/rollup-plugin-css" className="package-link">
    <h3>@visulima/rollup-plugin-css</h3>
