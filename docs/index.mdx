...
A bundler for Node.js and TypeScript libraries. Point it at your `package.json` and get optimized ESM and CJS bundles — with TypeScript declarations, CSS processing, and tree shaking out of the box.
