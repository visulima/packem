...
A bundler for Node.js and TypeScript libraries. Point it at your `package.json` and get the ESM and CJS output your `package.json` declares — with TypeScript declarations, CSS processing, and tree shaking out of the box.
