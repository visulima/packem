...
Packem is a bundler for Node.js and TypeScript libraries. It reads your `package.json` exports, picks the right entry points, and produces optimized ESM and CJS bundles — with TypeScript declarations, CSS processing, and tree shaking included.
