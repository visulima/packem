...
describe("typedoc-plugins/tag-error", function () {
    ...
    before(async () => {
        const sourceFilePatterns = [utils.normalizePath(FIXTURES_PATH, "**", "*.ts")];
        ...
        typeDoc.bootstrap({
            logLevel: "Error",
            entryPoints: files,
            plugin: [plugins["typedoc-plugin-tag-error"]],
    ...
    describe("error definitions", () => {
        ...
        it("should find an error tag before the module definition (raw text)", () => {
            ...
            expect(errorDefinition.comment.summary[0]).to.have.property("text", "An error statement occurring before the `@module` definition.");
        });
        ...
        it("should find an error tag before the module definition (with {@link})", () => {
            ...
            expect(errorDefinition.comment.summary[0]).to.have.property("kind", "text");
            expect(errorDefinition.comment.summary[0]).to.have.property("text", "An error statement occurring before the `@module` definition. See ");
            ...
            expect(errorDefinition.comment.summary[3]).to.have.property("text", "module:fixtures/customerror~CustomError Custom label");
        ...
        it("should find an error tag after the module definition (error with params, pure text)", () => {
            ...
            expect(errorDefinition.comment.summary).to.lengthOf(1);
            expect(errorDefinition.comment.summary[0]).to.have.property("kind", "text");
            expect(errorDefinition.comment.summary[0]).to.have.property("text", 'An error statement occurring after the "@module" definition.');
        ...
        it("should find an error tag before the export keyword", () => {
            ...
            expect(errorDefinition.comment.summary).to.lengthOf(1);
            expect(errorDefinition.comment.summary[0]).to.have.property("kind", "text");
            expect(errorDefinition.comment.summary[0]).to.have.property("text", "An error statement occurring before the export keyword.");
        });
        ...
        it("should find an error tag after the export keyword", () => {
            ...
            expect(errorDefinition.comment.summary).to.lengthOf(1);
            expect(errorDefinition.comment.summary[0]).to.have.property("kind", "text");
            expect(errorDefinition.comment.summary[0]).to.have.property("text", "An error statement occurring after the export keyword.");
        });
        ...
        it("should find an error tag inside a method", () => {
            ...
            expect(errorDefinition.comment.summary).to.lengthOf(1);
            expect(errorDefinition.comment.summary[0]).to.have.property("kind", "text");
            expect(errorDefinition.comment.summary[0]).to.have.property(
                "text",
            ...
            expect(errorDefinition.typeParameters[0].comment.summary[0]).to.have.property("kind", "text");
            expect(errorDefinition.typeParameters[0].comment.summary[0]).to.have.property("text", "Description of the error. Please, see ");
