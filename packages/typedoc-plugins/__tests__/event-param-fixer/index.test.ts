...
describe("typedoc-plugins/event-param-fixer", function () {
    ...
    describe("eventInfo parameter definition", () => {
        ...
        it('should add the "eventInfo" parameter for event without params and without comment', () => {
            ...
            expect(eventFooNoText.typeParameters[0].comment.summary[0]).to.have.property("text", "An object containing information about the fired event.");
        });
        ...
        it('should add the "eventInfo" parameter for event without params, but with comment', () => {
            ...
            expect(eventFoo.typeParameters[0].comment.summary[0]).to.have.property("text", "An object containing information about the fired event.");
        });
        ...
        it('should add the "eventInfo" parameter for event with params and comment', () => {
            ...
            expect(eventFooWithParams.typeParameters[0].comment.summary[0]).to.have.property("text", "An object containing information about the fired event.");
        });
        ...
        it('should add the "eventInfo" parameter for the "change" event for observable property', () => {
            ...
            expect(eventObservableChange.typeParameters[0].comment.summary[0]).to.have.property(
                "text",
        ...
        it('should add the "eventInfo" parameter for the "set" event for observable property', () => {
            ...
            expect(eventObservableSet.typeParameters[0].comment.summary[0]).to.have.property("text", "An object containing information about the fired event.");
        });
    });
});
