...
export type EventFooWithParams = {
    name: string;
    args: [p1: string, p2: number, p3: ExampleType];
};
...
export type EventFooComplex<Param extends "a" | "b" | "c" = "a"> = {
    args: Param extends "c" ? [p1: string, p2: ExampleType] : [];
};
...
export type InterfaceChangeEvent = {
    ...
    args: [name: string, value: any, oldValue: any];
};
