...
declare type ConditionalInfer<G> = G extends (infer H)[][] ? H : never;
...
// #endregion
export { ConditionalInfer, GenericExtends, genericFunction, GenericInterface, GenericKlass, GenericType, Mapped };
