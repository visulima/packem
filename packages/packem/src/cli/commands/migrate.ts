...
// eslint-disable-next-line n/no-unsupported-features/node-builtins -- node:readline/promises is stable since Node 17; the rule's version metadata is stale and the package engines (^22.14.0) already satisfy it.
