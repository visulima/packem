    ...
    it("should generate proper assets for each exports", async () => {
        await createIntegrationTest(
            ...
            async ({ dir }) => {
                ...
                const requiredFiles = ["dist/index.js", "dist/index.cjs", "dist/ui.js", "dist/ui.cjs"];
                ...
                expect(clientClientChunkFiles.map((f) => extname(f)).sort()).toEqual([".cjs", ".js"]);
                ...
                // cjs and esm, check the extension and files amount
                expect(serverChunkFiles.map((f) => extname(f)).sort()).toEqual([".cjs", ".js"]);
