...
- Perform testing only on in-scope systems, and respect systems and activities which are out-of-scope. Systems currently considered in-scope are the official demonstration/test servers provided by the Visulima development team.
...
The vulnerability is kept private until a majority of instances have updated to a safe version or applied a hotfix. The Visulima development team coordinates efforts to update once the patch is issued.

## Official Channels

To help us receive vulnerability submissions we use the following official reporting channel:

- security@visulima.com
- [GitHub advisories](https://github.com/visulima/visulima/security/advisories/new)
